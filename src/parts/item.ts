...
export class Item extends MyDisplay {
  ...
  protected _update():void {
    ...
    const lineWidth = 0.1
    const lineColor = new Color(0x000000)
    ...
    const grad = 'linear-gradient(' + ((this._angle1 + this._angle2) * 0.5) + 'deg, ' + color1.getStyle() + ' ' + p1 + '%, ' + color2.getStyle() + ' ' + (p2 - lineWidth) + '%, ' + lineColor.getStyle() + ' ' + p2 + '%, ' + lineColor.getStyle() + ' ' + p2 + '%, ' + color3.getStyle() + ' ' + (p2 + lineWidth) + '%, ' + color2.getStyle() + ' ' + p3 + '%)'
